...
<html lang="en">
  <head>
    ...
    <title>Multifactor OTP Authentication</title>
    <!-- Icons-->
        ...
        <div class="col-md-6">
          <div class="card mx-4">
            <div class="card-body p-4">
              ...
              <p class="text-muted">Enter your OTP to verify authenticate your Login.</p>
            ...
            <?php } ?>
              <form action="<?php echo current_url(); ?>" method="post">
                <div class="input-group mb-3">
                    ...
                    <input class="form-control" type="text" name="onetimepass" placeholder="One time Password">
                </div>
