                                            ...
                                            <?php 
                                             foreach($patients as $patient){ ?>
                                                <tr>
                                                    ...
                                                    <td><a href="<?php echo admin_url('reports/individual_pat_reports/'.$patient->user_id); ?>" class="btn btn-primary waves waves-effect" data-toggle="tooltip" data-original-title="View individual meetings reports">View Reports</a></td>
                                                </tr>
                                            <?php } ?>
