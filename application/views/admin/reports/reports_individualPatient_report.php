                        ...
                        <div class="row">
                            <div class="col-md-3 col-sm-6">
                                <div class="text-center">
                                   ...
                                   <!--  <table class="d-none d-lg-block table table-borderless">
                                        <tr>
                                            <td class="text-muted small text-uppercase font-weight-bold">Email</td>
                                            <td><?php echo $user->email; ?></td>
                                        </tr>
                                        <tr>
                                            <td class="text-muted small text-uppercase font-weight-bold">Personal ID</td>
                                            <td><?php echo $user->personal_id; ?></td>
                                        </tr>
                                        <tr>
                                            <td class="text-muted small text-uppercase font-weight-bold">Contact no</td>
                                ...
                                <form action="<?php echo current_url_with_get(); ?>#listallmeetings" class="row">
                                    ...
                                    <div class="col-md-3 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control form-control-sm select2" name="dt" id="filterDoctor">
                                                <?php foreach ($doctors as $dkey => $dval) {
                                                    $selected = (isset($_GET['dt']) && $_GET['dt'] == $dkey)?'selected':"";
